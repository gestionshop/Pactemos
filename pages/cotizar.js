    ...
    return (
      <>
        <Head>
          ...
          <meta
            name="description"
            content="Nos empeñamos en darte mas dinero. Ingresa al cotizador en línea para obtener el valor estimado que puedes recibir por tus joyas de oro y artículos."
          />
        </Head>
        <div className="cotizar">
          ...
          <img
            ...
            alt="compraventas pactemos, casas de empeño, compraventas en cartagena, compraventas en santa marta, comprayventas"
          />
          <div className="container">
            <section className="offices-header">
              <h1>Cotizador en línea</h1>
              <p>
                Rellene los campos y recuerde que la información personal la
                utilizaremos para confirmarle cuánto dinero le damos por su
                artículo
              </p>
              ...
              <div className="cotizar-select">
                {data.map((item) => (
                  <div
                    ...
                    className={`cotizar-select-item ${
                      this.state.type && item.name === this.state.type.name
                        ? 'active'
                        : ''
                    }`}
                  >
              ...
              {this.state.type &&
                (this.state.type.name === 'Joyería' ||
                  ...
                  <div className="cotizar-select">
                    {this.state.type.options.map((item) => (
                      <div
                        onClick={() => this.selectSubType(item)}
                        className={`cotizar-select-item ${
                          this.state.subtype &&
                          item.name === this.state.subtype.name
                            ? 'active'
                            : ''
                        }`}
                      >
              ...
              {this.state.subtype && this.state.subtype.options && (
                <div className="cotizar-select">
                  {this.state.subtype.options.map((item) => (
                    <div
                      onClick={() => this.selectCategory(item)}
                      className={`cotizar-select-item ${
                        this.state.category &&
                        item.name === this.state.category.name
                          ? 'active'
                          : ''
                      }`}
                    >
                  ...
                  <div className="cotizar-select">
                    <div className="form-row">
                      ...
                      >
                        ...
                        <option value="Pistola de Impacto">
                          Pistola de Impacto
                        </option>
              ...
              {this.state.type &&
                ...
                this.state.category && (
                  <>
                    ...
                    <div className="cotizar-select">
                      <div className="form-input">
                        <label className="label etiqueta-izquierda">
                          {this.state.category.value === 'Celular' &&
                          this.state.category.name === 'tipo_tecnologia'
                            ? 'Tiempo de uso en meses. (1, 2, 6) - Debe ser menor a 6 meses para poder recibirlo *'
                            : this.state.category.value !== 'Celular' &&
                              this.state.category.name === 'tipo_tecnologia'
                            ? 'Tiempo de uso en meses. (1, 2, 6) - Debe ser menor a 12 meses para poder recibirlo *'
                            : 'Tiempo de uso (Ej. 2 año y/o 3 meses) *'}
                        </label>
                    ...
                    <div className="cotizar-select">
                      <div className="form-input">
                        <label className="label">{`¿Tiene factura? ${
                          this.state.category.name === 'tipo_tecnologia'
                            ? '(Indispensable)'
                            : ''
                        } *`}</label>
              ...
              {this.state.type && this.state.type.name === 'Otros' && (
                <>
                  <div className="cotizar-select">
                    <div className="form-input">
              ...
              {this.state.type && this.state.type.name === 'Vender CDT' && (
                <>
                  <div className="cotizar-select">
                    <div className="form-input">
                  ...
                  <div className="modal-content">
                    ...
                    >
                        ...
                        this.state.localizacion.value ===
                          ...
                          <div className="form-row">
                            ...
                            >
                              <option></option>
                              <option value="PCT 02">
                                Centro, Calle del Cabo. C.C Invercrédito. Local
                                5
                              </option>
                              <option value="PCT 01">
                                Centro, Calle del Cabo. C.C Invercrédito. Local
                              ...
                              <option value="PCT 04">
                                Centro. Portal De Los Dulces, Calle Portocarrero
                              </option>
                              <option value="PCT 16">
                                Centro, Av Daniel Lemaitre al lado del Hotel San
                                Felipe
                              </option>
                              <option value="PCT 07">
                                Bocagrande. Cra 3 # 5-187
                              </option>
                              <option value="PCT 12">
                                San jose de los Campanos. Cra 101B. # 38A-83
                              </option>
                              <option value="PCT 13">
                                Boquilla, Calle Principal. CRA 9 # 59-17
                              </option>
                              <option value="PCT 14">
                                Bazurto, C.C Almacentro. Local 4
                              </option>
                              <option value="PCT 21">
                                Avenida Pedro de Heredia, Frente a la Castellana
                              </option>
                              <option value="PCT 22">Las Ramblas</option>
                              <option value="PCT 23">Bosque</option>
                              <option value="PCT 19">
                                Pozón, Carrera 88 # 56-1. A una cuadra de la
                                entrada
                              </option>
                              <option value="PCT 20">
                                Plazuela, Frente al multicentro La Plazuela, Dg.
                                31 # 71-59
                              </option>
                              <option value="PCT 201">
                                Crespo, Calle 70 # 2-67 al lado de Megatiendas
                              </option>
                              <option value="PCT 103">
                                Superefectivo Terminal
                              </option>
                              <option value="PCT 104">
                                Superefectivo Socorro
                              </option>
                            </select>
                          </div>
                        )}
                        ...
                        this.state.localizacion.value === 'Arjona' && (
                          <div className="form-row">
                            ...
                            >
                              <option></option>
                              <option value="PCT 17">
                                Arjona, Calle del Coco con Mercado, Esquina.
                              </option>
                            </select>
                          </div>
                        )}
                        ...
                        this.state.localizacion.value === 'Santa Marta' && (
                          <div className="form-row">
                            ...
                            >
                              <option></option>
                              <option value="PCT 09">
                                Centro, Cra 5, Edificio Galaxia. Local 102
                              </option>
                              <option value="PCT 10">
                                Centro, Cra 5 # 21 - 16
                              </option>
                              ...
                              <option value="PCT 202">
                                Avenida El Libertador #27 - 231
                              </option>
                              <option value="PCT 18">
                                Concepción 2 Mz Y Casa 19. 2da Etapa{' '}
                              </option>
                              <option value="PCT 06">
                                Av. el Rio con Av. del libertador 30 -146
                              </option>
                              {/* <option value="PCT 102">Avenida Del Ferrocarril #5-08</option> */}
                              <option value="PCT 105">
                                Vía a Minca, Cra 66 N. 39 - 81, Yucal
                              </option>
                              <option value="PCT 107">
                                Av. Santa rita, Calle 22 con 18. Esquina
                              </option>
                              <option value="PCT 108">
                                Bonga, Cra 17 con 7
                              </option>
                              <option value="PCT 109">
                                Rodadero, Cra 4 # 18-62, al lado de Rapimercar
                              </option>
                            </select>
                          </div>
                        )}
                      ...
                      <div className="form-row">
                        ...
                        />
                        <span>
                          Debe ingresar un número correcto para que el equipo
                          comercial pueda confirmarle la valoración
                        </span>
                      </div>
                      <div className="form-row">
