...
function (_Component) {
  ...
  function Cotizar() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "number_format", function (amount) {
      console.log('number_format', number_format);
      amount += '';
      return amount.split(".").join("");
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "number_format_mil", function (amount) {
      console.log('number_format_mil', number_format_mil);
      var num = amount += '';
      num = num.replace(/\./g, '');
...
//# sourceMappingURL=cotizar.js.b9c0d2c735236aebff55.hot-update.js.map