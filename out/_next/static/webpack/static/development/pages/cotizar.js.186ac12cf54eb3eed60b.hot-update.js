...
function (_Component) {
  ...
  _createClass(Cotizar, [{
    key: "number_format",
    value: function number_format(amount) {
      amount += '';
      return amount.split(".").join("");
    }
  }, {
    key: "number_format_mil",
    value: function (_number_format_mil) {
      function number_format_mil(_x) {
        return _number_format_mil.apply(this, arguments);
      }

      number_format_mil.toString = function () {
        return _number_format_mil.toString();
      };

      return number_format_mil;
    }(function (amount) {
      var num = amount += '';
      num = num.replace(/\./g, '');
...
//# sourceMappingURL=cotizar.js.186ac12cf54eb3eed60b.hot-update.js.map